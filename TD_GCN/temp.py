...
# 读取原数据
with open('/data/ices/ionicbond/global_match-main/real/data/data/train_label.npy', 'rb') as f:
...
with open('/data/ices/ionicbond/global_match-main/real/data/data/train_label.pkl', 'wb') as f:
