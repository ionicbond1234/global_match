...
# 定义参数空间
# 4 weights with bounds from 0.2 to 1.2
...
def objective(weights):
    ...
    for i in tqdm(range(len(label))):
        l = int(label[i])
        # 计算加权和
        combined_scores = sum(r[i][1] * weight for r, weight in zip([r1, r2, r3, r4, r5, r6, r7, r8, r9], weights))
        # 找到最高分的索引，即 Top 1
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_mixformer_bone1',
                        default='/data/ices/ionicbond/global_match-main/HDBN/Mix_Former/output/skmixf__V1_B_1/epoch68_test_score.pkl')
    parser.add_argument('--test_mixformer_bone2',
                        default='/data/ices/ionicbond/global_match-main/HDBN/Mix_Former/output/skmixf__V1_B_2/epoch69_test_score.pkl')
    parser.add_argument('--test_mixformer_bone3',
                        default='/data/ices/ionicbond/global_match-main/HDBN/Mix_Former/output/skmixf__V1_B_3/epoch70_test_score.pkl')
    ...
    parser.add_argument('--test_mixformer_joint',
                        default='/data/ices/ionicbond/MS-CTR-GCN-master/work_dir/mixformer/epoch1_test_score.pkl')
    ...
    with open(arg.test_mixformer_bone1, 'rb') as r5:
        r5 = list(pickle.load(r5).items())
    with open(arg.test_mixformer_bone2, 'rb') as r6:
        r6 = list(pickle.load(r6).items())
    with open(arg.test_mixformer_bone3, 'rb') as r7:
        r7 = list(pickle.load(r7).items())


    with open(arg.test_tdgcn_joint, 'rb') as r8:
        r8 = list(pickle.load(r8).items())

    with open(arg.test_mixformer_joint, 'rb') as r9:
        r9 = list(pickle.load(r9).items())
